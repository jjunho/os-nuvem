...
| **Gorjeta** (K026, K400, K553, K898) | Desligada por padrão (regra vigente). Um clique a mostra no Orçamento e na Proposta como valor **sugerido, não incluído**, com os valores de K898. Fica só no texto da Proposta: nunca vira Pagamento, Invoice nem Conta a pagar, e o sistema não faz rateio nem fundo (Juliano, 24/09/2026). | K553/K898 vigentes; Carlos (27/07) quer que a gorjeta seja “mencionada no orçamento… dizer que é sugerido” e que agências possam pagar adiantado. |
...
|---|---|---|---|
| **Sinal e saldo** | Sinal 20% (referência), saldo até o 1º dia do tour (K572–K573) | 30% de sinal, 70% até 30 dias antes (roteiro Embarque 2026 e propostas reais, K335) | **Padrão: 30% de sinal e saldo até 30 dias antes (D-30)**, editáveis por Proposta. Decisão de Juliano em 24/09/2026, a confirmar com Carlos (K572–K573 era a regra vigente). Motivo: com o saldo no 1º dia, a regra de Carlos "saldo integral antes de emitir item não reembolsável" (K918) dispararia em quase toda viagem, porque o KTX abre ~1 mês antes. O sistema avisa quando o sinal não cobre as penalidades já comprometidas e quando um item não reembolsável vai ser emitido sem o saldo pago; seguir adiante exige override de Faturamento ou Admin (ADR-0001). |

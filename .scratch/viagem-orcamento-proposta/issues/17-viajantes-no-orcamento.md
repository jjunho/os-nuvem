# 17: Viajantes in the Orçamento

**What to build:** The Orçamento prices the Viagem's own Viajantes (ticket 02), never a retyped headcount. The salesperson chooses which Viajantes take part in each Dia ("DMZ for 6, Jeju for 8"), and marks a line as applying to only some Viajantes. Child and infant prices apply from each Viajante's age. Adding a Viajante to the Viagem makes them available in the Orçamento at once. Spec: stories 33, 38; glossary: Viajante.
